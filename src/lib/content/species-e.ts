...
export const SPECIES_E: Species[] = [
	...
	},
	{
		...
		spot: [
			...
			'Form is extremely variable: a low sprawling mat on exposed moorland, a neat column on chalk downland, a scruffy shrub in between. All are the same species.',
